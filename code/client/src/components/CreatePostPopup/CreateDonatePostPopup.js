...
/**
 * Creates a popup component for creating or editing a donate post.
 * @param {Object} props - The component props.
 * @param {Function} props.setPopupOpen - The function to set the popup open state.
 * @param {Function} props.reloadPosts - The function to reload the posts.
 * @param {boolean} props.isEditing - Indicates if the post is being edited.
 * @param {Object} props.post - The post object being edited.
 * @returns {JSX.Element} The create donate post popup component.
 */
...
const CreateDonatePostPopup = ({setPopupOpen, reloadPosts, isEditing, post}) => {
    ...
    const handleCreatePostClick = async () => {
            ...
            if (selectedFiles.length > 0) {
                ...
                handleCreatePost('DONATE', title, postContent, null, null, base64Urls, null, 0)
                    .then((resp) => {
    ...
    return (
        <div className={'content-container'}>
            <div className={'title-container'}>{isEditing ? 'Edit' : 'Create'} Donate Post</div>
...
export default CreateDonatePostPopup;